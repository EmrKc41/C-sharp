...
namespace Doviz
{
    public partial class sek : Form
    {
        ...
        private void sek_Load(object sender, EventArgs e)
        {
            ...
            string sekalis = xmldosya.SelectSingleNode("Tarih_Date/Currency[@Kod='SEK']/BanknoteBuying").InnerXml;
            label3.Text = sekalis;
            string seksatis = xmldosya.SelectSingleNode("Tarih_Date/Currency[@Kod='SEK']/BanknoteSelling").InnerXml;
            label4.Text = seksatis;
