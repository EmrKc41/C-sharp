...
namespace Doviz
{
    public partial class cad : Form
    {
        ...
        private void cad_Load(object sender, EventArgs e)
        {
            ...
            string cadalis = xmldosya.SelectSingleNode("Tarih_Date/Currency[@Kod='CAD']/BanknoteBuying").InnerXml;
            label3.Text = cadalis;
            string cadsatis = xmldosya.SelectSingleNode("Tarih_Date/Currency[@Kod='CAD']/BanknoteSelling").InnerXml;
            label4.Text = cadsatis;
