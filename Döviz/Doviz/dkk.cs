...
namespace Doviz
{
    public partial class dkk : Form
    {
        public dkk()
        {
            InitializeComponent();
        }
        OleDbConnection baglanti = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=doviz_vt.accdb");
        private void dkk_Load(object sender, EventArgs e)
        {
            this.Opacity = 10; 
            timer1.Interval = 15; 
            timer1.Start(); 
            ...
            string dkkalis = xmldosya.SelectSingleNode("Tarih_Date/Currency[@Kod='DKK']/BanknoteBuying").InnerXml;
            label3.Text = dkkalis;
            string dkksatis = xmldosya.SelectSingleNode("Tarih_Date/Currency[@Kod='DKK']/BanknoteSelling").InnerXml;
            label4.Text = dkksatis;
