...
namespace Doviz
{
    public partial class aud : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            OleDbCommand komut = new OleDbCommand("Insert into  Satan (Satan_AdSoyad, Satis_Turu, Satis_Tarihi, Satis_Miktari,Satis_Kuru) VALUES (@p1, @p2, @p3, @p4, @p5)", baglanti);
