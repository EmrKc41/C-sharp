...
namespace Doviz
{
    public partial class nok : Form
    {
        ...
        private void nok_Load(object sender, EventArgs e)
        {
            ...
            string nokalis = xmldosya.SelectSingleNode("Tarih_Date/Currency[@Kod='NOK']/BanknoteBuying").InnerXml;
            label3.Text = nokalis;
            string noksatis = xmldosya.SelectSingleNode("Tarih_Date/Currency[@Kod='NOK']/BanknoteSelling").InnerXml;
            label4.Text = noksatis;
